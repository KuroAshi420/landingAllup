...
// Entreprise
export const CompaniesTable = loadable(
  () => import("./Tables/demos/CompaniesTable"),
  {
    fallback: <Loading />,
  }
);
// Categories
export const Categories = loadable(() => import("./Tables/demos/Categories"), {
  fallback: <Loading />,
});
// Reports
export const Reports = loadable(() => import("./Tables/demos/Reports"), {
  fallback: <Loading />,
});
// Users
export const UsersTable = loadable(() => import("./Tables/demos/UsersTable"), {
  fallback: <Loading />,
});
// Deals
export const Deals = loadable(() => import("./Pages/Ecommerce/Deals"), {
  fallback: <Loading />,
});

export const MyDeals = loadable(
  () => import("./Pages/Ecommerce/myDeals/MyDeals"),
  {
    fallback: <Loading />,
  }
);

export const DealsIn = loadable(
  () => import("./Pages/Ecommerce/dealsIn/DealsIn"),
  {
    fallback: <Loading />,
  }
);

export const CreateDeal = loadable(
  () => import("./Pages/Ecommerce/CreateDeal"),
  {
    fallback: <Loading />,
  }
);
...
export const EmployeesTables = loadable(
  () => import("./Tables/demos/EmployeesTables"),
  {
    fallback: <Loading />,
  }
);

export const DemandsEmployeesTables = loadable(
  () => import("./Tables/demos/DemandsEmployeesTable"),
  {
    fallback: <Loading />,
  }
);
export const DemandEmployees = loadable(
  () => import("./Tables/demos/DemandEmployees"),
  {
    fallback: <Loading />,
  }
);

export const ShoppingcardTable = loadable(
  () => import("./Tables/demos/ShoppingcardTable"),
  {
    fallback: <Loading />,
  }
);
