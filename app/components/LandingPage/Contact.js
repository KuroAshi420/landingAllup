    ...
    <div className={classes.contact}>
      <div className={classes.container}>
        <div className={classes.contactBubble}>
          <Title title={intl.formatMessage(messages.titleContact)} desc="We'd love to hear from you, whether you have a question about us, our team is ready to answer all your questions.." align="left" nomargin />
